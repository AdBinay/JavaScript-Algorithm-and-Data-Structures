...
according to this table which lists the strokes in order of priority; top (highest) to
bottom (lowest):
...
par and strokes will always be numeric and positive. We have added an array of all the
