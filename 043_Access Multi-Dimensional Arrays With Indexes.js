...
When you use brackets to access your array, the first set of brackets refers to
the entries in the outermost (the first level) array,
...
like array [0][0] and even this array [0] [0] is not allowed. Although JavaScript is
